 ...
 * @author neha
 */
public class artscholar extends javax.swing.JFrame {

    /**
     * Creates new form artscholar
     */
    public artscholar() {
        initComponents();
    ...
    String alllinks [] = {"https://www.canadian-universities.net/Scholarships/V/Visual-Arts-Scholarship.html",
        "https://www.ecuad.ca/student-life/financial-aid-awards/funding-for-undergraduate-students/external-scholarships",
        "https://womensartofcanada.ca/scholarships/"};
    ...
    private void initComponents() {
        ...
        jLabel4.setText("2. Emily Carr");

        jLabel5.setText("For arts students!");

        BTNSICKKIDS.setText("WAA");
        ...
        jLabel6.setText("3. Women's Art Association ");

        jLabel7.setText("For arts students passionate about leadership!");

        jLabel1.setFont(new java.awt.Font("Microsoft JhengHei UI Light", 1, 14)); // NOI18N
        jLabel1.setText("ARTS Scholarship Opportunities!");
        ...
        jLabel3.setText("1. Visual Arts");

        jLabel2.setText("Canada's Higher Education and Career Guide. ");

        BTNGOOGLE.setText("EC");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(artscholar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new artscholar().setVisible(true);
            }
        });
    }
